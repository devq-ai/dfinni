...
DEFINE FIELD specialization ON TABLE user TYPE option<string>;
...
DEFINE FIELD risk_level ON TABLE patient TYPE option<string> ASSERT $value = NONE OR $value IN ['Low', 'Medium', 'High'];
